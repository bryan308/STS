...
if (isset($_POST['submit'])) {
    ...
    $lastName = $_POST['last_name'];                //2
    $firstName = $_POST['first_name'];              //3
    $middleName = $_POST['middle_name'];            //4
    $birthDate = $_POST['date_of_birth'];           //5
    $schoolYear = $_POST['school_year'];            //6
    $gender = $_POST['gender'];                     //7
    $placeBirth = $_POST['place_of_birth'];         //8
    $citizenship = $_POST['citizenship'];           //9
    $address = $_POST['stu_address'];               //10
    $generalAverage = $_POST['gen_average'];        //11
    $guardian = $_POST['guardian'];                 //12
    $occupation = $_POST['occupation'];             //13
    $interCourseComplete = $_POST['inter_course_com'];//14
    ...
    if (isset($_POST['subjects'])) {
        ...
        foreach ($subjects as $subject) {
            ...
            $sql = "INSERT INTO old_subjects_list (subject_name, final_remark) VALUES ('$subject_name', '$final_remark')";
            $con->query($sql) or die($con->error);
        }
    }
