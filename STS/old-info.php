                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="2" class="bold-letter">Classified as:
                                    <span class="value">
                                        <?php echo $row['class_as_tbl1'] ?>
                                    </span>
                                </td>
                                <td colspan="3" class="bold-letter">Classified as:
                                    <span class="value">
                                        <?php echo $row['school_year_tbl1'] ?>
                                    </span>
                                </td>
                            </tr>
                            <tr class="trcenter">
                            ...
                            <tr class="trcenter">
                                <td colspan="1">
                                    <?php echo $row['curr_yr1_tbl1'] ?>
                                </td>
                                <td colspan="1">
                                    <?php echo $row['subject1_tbl1'] ?>
                                </td>
                                <td colspan="1">
                                    <?php echo $row['final_rating1_tbl1'] ?>
                                    
                                </td>
                                <td colspan="1">
                                    <?php echo $row['action_taken1_tbl1'] ?>
                                    
                                </td>
                                <td colspan="1">
                                    <?php echo $row['credits_earned1_tbl1'] ?>
                                    
                                </td>
                            </tr>
                            <tr class="trcenter">
                                <td colspan="1">
                                    <?php echo $row['curr_yr2_tbl1'] ?>
                                </td>
                                <td colspan="1">
                                    <?php echo $row['subject2_tbl1'] ?>
                                </td>
                                <td colspan="1">
                                    <?php echo $row['final_rating2_tbl1'] ?>
                                    
                                </td>
                                <td colspan="1">
                                    <?php echo $row['action_taken2_tbl1'] ?>
                                    
                                </td>
                                <td colspan="1">
                                    <?php echo $row['credits_earned2_tbl1'] ?>
