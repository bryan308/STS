...
if(isset($_POST['submit'])) {
    ...
    school_tbl1 = '$schooltable1', 
    class_as_tbl1 = '$classAstable1', 
    school_year_tbl1 = '$schoolYeartable1', 
    curr_yr1_tbl1 = '$currentYearr1table1', 
    subject1_tbl1 = '$subject1table1', 
    final_rating1_tbl1 = '$finalRating1table1', 
    action_taken1_tbl1 = '$actionTaken1table1', 
    credits_earned1_tbl1 = '$creditsEarned1table1' WHERE id = '$id'";
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="bold-letter">
                                        ...
                                        LRN:
                                        <span class="value">
                                            <input type="text" name="lrn" id="lrnInput" value="<?php echo $row['lrn'] ?>" maxlength="12" minlength="12" autocomplete="off" required>
                                        </span>
                                    </td>
                                </tr>
                            </table>
